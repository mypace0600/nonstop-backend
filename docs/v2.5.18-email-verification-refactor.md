...
1. [x] `SignUpResponseDto.java` 생성
2. [x] `EmailVerificationRequestDto.java` 생성
3. [x] `AlreadyVerifiedException.java` 생성
4. [x] `AuthService.java` 인터페이스 수정
5. [x] `AuthServiceImpl.java` 로직 분리
6. [x] `AuthController.java` 엔드포인트 변경
7. [x] `SignupResendRequestDto.java` 삭제
8. [ ] 테스트 코드 업데이트
9. [x] PRD 문서 업데이트
