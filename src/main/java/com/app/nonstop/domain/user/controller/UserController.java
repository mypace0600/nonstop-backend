...
public class UserController {
     ...
     * @param size 페이지 크기
     * @return ApiResponse<List<PostDto.Response>> 사용자의 게시글 목록
     */
    @Operation(summary = "내 게시글 조회", description = "현재 로그인된 사용자가 작성한 게시글 목록을 페이징하여 조회합니다.", security = @SecurityRequirement(name = "bearerAuth"))
    @GetMapping("/me/posts")
    public ResponseEntity<ApiResponse<List<PostDto.Response>>> getMyPosts(
        ...
        List<PostDto.Response> posts = postService.getUserPosts(userId, page, size, userId);
